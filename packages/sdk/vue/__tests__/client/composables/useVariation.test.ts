...
it('useBoolVariation re-evaluates when context changes after identify', async () => {
  ...
  expect((client.boolVariation as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});
...
it('useStringVariation re-evaluates when context changes after identify', async () => {
  ...
  expect((client.stringVariation as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});
...
it('useNumberVariation re-evaluates when context changes after identify', async () => {
  ...
  expect((client.numberVariation as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});
...
it('useJsonVariation re-evaluates when context changes after identify', async () => {
  ...
  expect((client.jsonVariation as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});

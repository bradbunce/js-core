...
it('useBoolVariationDetail re-evaluates when context changes after identify', async () => {
  ...
  expect((client.boolVariationDetail as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});
...
it('useStringVariationDetail re-evaluates when context changes after identify', async () => {
  ...
  expect((client.stringVariationDetail as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});
...
it('useNumberVariationDetail re-evaluates when context changes after identify', async () => {
  ...
  expect((client.numberVariationDetail as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});
...
it('useJsonVariationDetail re-evaluates when context changes after identify', async () => {
  ...
  expect((client.jsonVariationDetail as jest.Mock).mock.calls.length).toBeGreaterThan(callsBefore);
});
